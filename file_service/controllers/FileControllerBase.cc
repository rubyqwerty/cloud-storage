...
void FileControllerBase::getOne(const HttpRequestPtr &req,
...
void FileControllerBase::updateOne(const HttpRequestPtr &req,
                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                   File::PrimaryKeyType &&id)
{
...
void FileControllerBase::deleteOne(const HttpRequestPtr &req,
                                   std::function<void(const HttpResponsePtr &)> &&callback,
                                   File::PrimaryKeyType &&id)
{
...
void FileControllerBase::get(const HttpRequestPtr &req,
                             std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<File> mapper(dbClientPtr);
    ...
    {
        mapper.findAll([req, callbackPtr, this](const std::vector<File> &v) {
                Json::Value ret;
                ret.resize(0);
                for (auto &obj : v)
                {
...
void FileControllerBase::create(const HttpRequestPtr &req,
                                std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
    ...
    try 
    {
        File object = 
            (isMasquerading()? 
             File(*jsonPtr, masqueradingVector()) : 
             File(*jsonPtr));
        auto dbClientPtr = getDbClient();
        auto callbackPtr =
            std::make_shared<std::function<void(const HttpResponsePtr &)>>(
        ...
        mapper.insert(
            object,
            [req, callbackPtr, this](File newObject){
