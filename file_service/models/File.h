...
class File
{
  public:
    ...
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getVerificationStatus() const noexcept;
    ///Set the value of the column verification_status
    void setVerificationStatus(const std::string &pVerificationStatus) noexcept;
    void setVerificationStatus(std::string &&pVerificationStatus) noexcept;
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<File, true, true>;
    friend drogon::orm::BaseBuilder<File, true, false>;
    friend drogon::orm::BaseBuilder<File, false, true>;
    friend drogon::orm::BaseBuilder<File, false, false>;
#ifdef __cpp_impl_coroutine
