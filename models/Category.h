...
class Category
{
  public:
     ...
     */
    explicit Category(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
     ...
     */
    Category(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const int32_t &getValueOfFileId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getFileId() const noexcept;
    ///Set the value of the column file_id
    void setFileId(const int32_t &pFileId) noexcept;
    ...
    File getFile(const drogon::orm::DbClientPtr &clientPtr) const;
    void getFile(const drogon::orm::DbClientPtr &clientPtr,
  ...
  private:
    ...
    std::shared_ptr<int32_t> fileId_;
    struct MetaData
    {
